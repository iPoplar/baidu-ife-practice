	...
	window.onload = function(){
         ...
         */
         function trim(str){
         	if(str && typeof str === "string"){
         		return str.replace(/(^\s*)|(\s*)$/g, ""); //除去前后空白字符
         		// 兼容中文空格和实体空格
         ...
         */
         function addAqiData(){
         	...
         	if(cityHandle(city.value) && valueHandle(aqiValue.value)){
         		...
         		canAdd = true;
         		// console.log("------aqiData--AddAqiData------");
         		// console.log(aqiData);
         ...
         */
         ...
         function cityHandle(str){
         	...
         	// console.log("trim_str:"+trim_str);
         	var reg_eng = /[^a-aA-Z]/g;
         	var reg_chi = /[^\u4e00-\u9fa5]/;
